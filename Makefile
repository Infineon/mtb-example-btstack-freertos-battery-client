...
DEFINES+=LEGATTDB_CHAR_PROP_READ=GATTDB_CHAR_PROP_READ
DEFINES+=LEGATTDB_CHAR_PROP_INDICATE=GATTDB_CHAR_PROP_INDICATE
DEFINES+=LEGATTDB_CHAR_PROP_NOTIFY=GATTDB_CHAR_PROP_NOTIFY
DEFINES+=WICED_BT_TRACE_ENABLE=1
