...
* File Name: main.c
*
* Description: This is the source code for the Bluetooth LE Battery Service
...
int main()
{
...
#ifdef BAS_1_1
    printf("Battery Service Client v1.1 Start\n" );
#else
    printf("Battery Service Client v1.0 Start\n" );
#endif
    ...
    {
        printf("create default heap sucessful: size %d\n", BT_STACK_HEAP_SIZE);
    }
